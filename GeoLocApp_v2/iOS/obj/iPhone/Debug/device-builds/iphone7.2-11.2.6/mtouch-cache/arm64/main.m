...
extern void *mono_aot_module_GeoLocApp_v2_iOS_info;
...
extern void *mono_aot_module_GeoLocApp_v2_info;
...
{
	mono_aot_register_module (mono_aot_module_GeoLocApp_v2_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_GeoLocApp_v2_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "GeoLocApp_v2.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
